...
export default function ListUser() {
  ...
  function getUser() {
    axios.get(`http://localhost:8888/api1/user/${id_employee}`).then(function(response) {
  ...
  const handleSubmit = (e) =>{
    e.preventDefault();
    axios.put(`http://localhost:8888/api1/user/${id_employee}/edit`,inputs).then(function(response){
      console.log(response.data);
      // console.log(id);
      navigate('/');
    });
